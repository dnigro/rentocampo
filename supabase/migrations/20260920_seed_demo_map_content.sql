...
select * from (
  ...
  union all
  select '20000000-0000-4000-8000-000000000003'::uuid, propietario.id, 'Campo mixto demo en Junín', 'PUBLICACIÓN DEMO · Campo de ejemplo utilizado para mostrar el funcionamiento de RentoCampo. No representa una oferta comercial activa. Establecimiento mixto agrícola-ganadero con ubicación estratégica en el noroeste bonaerense.', 'Junín, Buenos Aires', 'Buenos Aires', 'Junín', 'Junín', -34.5850, -60.9589, 410, 'mixta', 'USD', 'a_convenir', 'Sí', 'activo'::public.campo_status from propietario
  union all
  select '20000000-0000-4000-8000-000000000004'::uuid, propietario.id, 'Campo agrícola demo en Venado Tuerto', 'PUBLICACIÓN DEMO · Campo de ejemplo utilizado para mostrar el funcionamiento de RentoCampo. No representa una oferta comercial activa. Campo agrícola de zona núcleo con acceso cercano a corredores productivos.', 'Venado Tuerto, Santa Fe', 'Santa Fe', 'General López', 'Venado Tuerto', -33.7456, -61.9688, 280, 'agricola', 'USD', 'inmediata', 'Sí', 'activo'::public.campo_status from propietario
  union all
  select '20000000-0000-4000-8000-000000000005'::uuid, propietario.id, 'Campo mixto demo en Rafaela', 'PUBLICACIÓN DEMO · Campo de ejemplo utilizado para mostrar el funcionamiento de RentoCampo. No representa una oferta comercial activa. Establecimiento mixto de referencia en la cuenca productiva de Rafaela.', 'Rafaela, Santa Fe', 'Santa Fe', 'Castellanos', 'Rafaela', -31.2503, -61.4867, 360, 'mixta', 'USD', 'a_convenir', 'Sí', 'activo'::public.campo_status from propietario
  union all
  ...
  union all
  select '20000000-0000-4000-8000-000000000007'::uuid, propietario.id, 'Campo mixto demo en Río Cuarto', 'PUBLICACIÓN DEMO · Campo de ejemplo utilizado para mostrar el funcionamiento de RentoCampo. No representa una oferta comercial activa. Campo mixto agrícola-ganadero del sur cordobés, pensado para mostrar filtros y mapa.', 'Río Cuarto, Córdoba', 'Córdoba', 'Río Cuarto', 'Río Cuarto', -33.1232, -64.3493, 520, 'mixta', 'USD', 'a_convenir', 'Sí', 'activo'::public.campo_status from propietario
  union all
  select '20000000-0000-4000-8000-000000000008'::uuid, propietario.id, 'Campo mixto demo en Tandil', 'PUBLICACIÓN DEMO · Campo de ejemplo utilizado para mostrar el funcionamiento de RentoCampo. No representa una oferta comercial activa. Establecimiento mixto en ambiente serrano productivo del centro-sur bonaerense.', 'Tandil, Buenos Aires', 'Buenos Aires', 'Tandil', 'Tandil', -37.3217, -59.1332, 450, 'mixta', 'USD', 'inmediata', 'Sí', 'activo'::public.campo_status from propietario
  union all
  select '20000000-0000-4000-8000-000000000009'::uuid, propietario.id, 'Campo agrícola demo en Balcarce', 'PUBLICACIÓN DEMO · Campo de ejemplo utilizado para mostrar el funcionamiento de RentoCampo. No representa una oferta comercial activa. Campo agrícola representativo del sudeste bonaerense.', 'Balcarce, Buenos Aires', 'Buenos Aires', 'Balcarce', 'Balcarce', -37.8462, -58.2552, 275, 'agricola', 'USD', 'campaña_próxima', 'Sí', 'activo'::public.campo_status from propietario
  union all
  select '20000000-0000-4000-8000-000000000010'::uuid, propietario.id, 'Campo ganadero demo en Azul', 'PUBLICACIÓN DEMO · Campo de ejemplo utilizado para mostrar el funcionamiento de RentoCampo. No representa una oferta comercial activa. Establecimiento ganadero con mejoras, creado como publicación demostrativa.', 'Azul, Buenos Aires', 'Buenos Aires', 'Azul', 'Azul', -36.7770, -59.8585, 600, 'ganadera', 'USD', 'a_convenir', 'Sí', 'activo'::public.campo_status from propietario
